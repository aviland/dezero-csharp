...
namespace dezero
{
    public class Step06
    {
        public static void Main()
        {
            ...
            Assert.AreEqual(y.creator, C);
            Assert.AreEqual(y?.creator?.input, b);
            Assert.AreEqual(y?.creator?.input?.creator, B);
            Assert.AreEqual(y?.creator?.input?.creator?.input, a);
            Assert.AreEqual(y?.creator?.input?.creator?.input?.creator, A);
